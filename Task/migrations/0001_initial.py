# Generated by Django 5.0 on 2023-12-18 22:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archive', models.ImageField(blank=True, null=True, upload_to='files/')),
                ('task', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='Task.task')),
            ],
        ),
        migrations.CreateModel(
            name='User',
